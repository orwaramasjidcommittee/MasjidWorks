...
export class ExpenseModel {
        ...
        this.rows = [
    {
        ...
        type: "expense",
        subRows: [
            { name: "🧱 ईंट", amount: 28000, type: "सामान", date: "2025-07-17" },
            { name: "🏗️ बालू, सीमेंट, सरिया, मोरंग", amount: 28500, type: "सामान", date: "2025-07-26" },
            { name: "👷 मज़दूरी", amount: 21005, type: "मज़दूरी", date: "2025-07-26" }
        ]
    },
    {
        name: "छत",
        ...
        type: "expense",
        subRows: [
            { name: "🔩 सेंट्रिंग", amount: 14000, type: "सामान", date: "2025-07-31" },
            { name: "🏗️ मोरंग, सीमेंट, सरिया", amount: 39170, type: "सामान", date: "2025-07-31" },
            { name: "👷 मज़दूरी", amount: 10000, type: "मज़दूरी", date: "2025-08-04" }
        ]
    },
    {
        name: "टांड़",
